  ...
  return L.divIcon({
    ...
    html: `<div style="position: relative; width: 38px; height: 38px;">
      ...
      ${online ? `<div style="position: absolute; bottom: -1px; right: -1px;
        ...
        background: #3DD16B; border: 2px solid #092C25;"></div>` : ''}
    </div>`,
    iconSize: [38, 38],
    iconAnchor: [19, 19],
    popupAnchor: [0, -20],
...
const tableIconCommunity = L.divIcon({
  ...
  html: `<svg width="20" height="20" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
    <circle cx="10" cy="10" r="8.5" fill="#9BC9AE" stroke="#092C25" stroke-width="1.6"/>
    <circle cx="10" cy="10" r="3" fill="#092C25"/>
  </svg>`,
  iconSize: [20, 20],
  iconAnchor: [10, 10],
  popupAnchor: [0, -10],
      ...
      {sharing && geoStatus === 'granted' && (
        <div style={{
          ...
          <button onClick={() => setShowFriends(v => !v)} aria-label="Afficher mes amis" style={{
            ...
            background: showFriends ? '#3DD16B' : 'rgba(245,246,243,0.20)',
      ...
      {mode === 'tables' && (
        <button
          ...
          style={{
            ...
            background: C.mint, color: '#092C25',
